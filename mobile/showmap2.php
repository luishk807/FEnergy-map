...
<script type="text/javascript">
 $(document).ready(function()
  ...
  function findmap()
  {
	  ...
	  var date1="";
	  var date2="";
	  if(fromm.length >0 && fromd.length >0 && fromy.length >0)
	  		date1=fromm+"/"+fromd+"/"+fromy;
	  if(tom.length >0 && tod.length >0 && toy.length >0)
	  		date2=tom+"/"+tod+"/"+toy;
  ...
  {
	  var xshow_area_chk="xshow_area="+value;
   ...
   <!--<input type="hidden" id="xarea_show" name="xarea_show" value="" />-->
   		<div id="content">
            ...
            <input type="hidden" id="xshow_area" name="xshow_area" value='<?Php echo $_REQUEST["xshow_area"]; ?>' />
                <input type="button" value='Hide Area Saved' onclick="findmap_show('')"/>
                <br/>
                <hr/>   
			...
			{
			?>
        	Address:&nbsp;<input type="text" size="10" id="xadd" name="xadd" value="<?php echo rgetGEO($starpoint);  ?>" />&nbsp;&nbsp;<input type="button" value="Search" onclick="refMap()"/>&nbsp;
            <!--<input type="button" value='Show Saved' onclick="findmap_show('yes')"/>-->
            <select id="xshow_area" name="xshow_area" onchange="findmap_show(this.value)">
            <option value="na">Choose One</option>
            <option value="1">Work Area</option>
            <option value="2">Temp Area</option>
        ...
        <div id="footer" style="text-align:center">
        	...
        	<div><input type="button" value="Create Map" onclick="checkArray()" />
            
            &nbsp;&nbsp; <select id="mapmenu" name="mapmenu" onchange="goBack(this.value)">
                <option value="">Choose</option>
                <option value="home.php">Main Menu</option>
            	<option value="showmap2.php">Reset Map</option>
                <option value="showmap2_all.php">View All Map</option>
