 ...
 function addPoint(event) {
  ...
  function deletemap(value)
  {
   ...
   <input type="hidden" id="farray" name="farray" value="" />
   		<div id="content">
            Hello <u><?php echo $user["username"]; ?></u>, Set the map as temporal or worked?<br/>
        ...
        <div id="footer" style="text-align:center">
        	...
        	<div>
             <input type="button" value="Worked" onclick="checkArray('create')" />&nbsp;&nbsp;
             <input type="button" value="Temporal" onclick="checkArray('tempo')" />&nbsp;&nbsp;
             <input type="button" value="Cancel" onclick="goBack('back')" />
            </div>
        </div>
    </form>
   </body>
