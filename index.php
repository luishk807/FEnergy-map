	...
	<div id="login_cont_panel">
        <div id="login_cont">
        	<div id="form">
                ...
                <div id="home_button">
                  <a href='fpassword.php'><img src="images/fpassword.png" border="0"alt="Forget Password" /></a>&nbsp;&nbsp;&nbsp;<input type="image"  src="images/login.png" onmouseover="javascript:this.src='images/login_r.png';" onmouseout="javascript:this.src='images/login.png';">
                </div>
               </form>
            </div>
        </div>
