...
<script type="text/javascript">
  ...
  function findmap_show()
  {
    ...
    function printthis()
  {
		var newWin = window.open("printviewv2.php","Family_Energy_Map_System_Print_View",'width=880, height=800,resizable');
...
<div id="main_cont">
   ...
   <fieldset>
   		<legend>Change Map: [<span style='font-size:15pt; font-style:italic'>Show Area Saved&nbsp;<input type="checkbox" id="xshow_area" name="xshow_area" onclick="findmap_show()" <?Php echo $xshow_area_sel; ?> /></span>]</legend>
   ...
   <br/>
    ...
    <br/>
        ...
        <br/>
        <input type="image"  src="images/createmapbtn.jpg" onmouseover="javascript:this.src='images/createmapbtn_r.jpg';" onmouseout="javascript:this.src='images/createmapbtn.jpg';">
        &nbsp;&nbsp;&nbsp;
